...
public class UIAtlas : MonoBehaviour
{
	...
	public void MarkAsDirty ()
	{
		...
		for (int i = 0, imax = list.Length; i < imax; ++i)
		{
 		...
 		UIFont[] fonts = UnityEngine.Object.FindObjectsOfTypeAll(typeof(UIFont)) as UIFont[];
        /*
		UnityEngine.Object[] loaded = Resources.LoadAll("Fonts");
		List<UIFont> fontsList = new List<UIFont>(loaded.Length);
		UIFont[] fonts = fontsList.ToArray();
		*/
