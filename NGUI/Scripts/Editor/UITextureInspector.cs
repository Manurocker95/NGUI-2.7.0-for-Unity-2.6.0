...
public class UITextureInspector : UIWidgetInspector
{
	...
	protected override bool DrawProperties ()
	{
		...
		{
Material mat = EditorGUILayout.ObjectField("Material", mTex.material, typeof(Material)) as Material;
		...
		{
Shader shader = EditorGUILayout.ObjectField("Shader", mTex.shader, typeof(Shader)) as Shader;
...
Texture tex = EditorGUILayout.ObjectField("Texture", mTex.mainTexture, typeof(Texture)) as Texture;
