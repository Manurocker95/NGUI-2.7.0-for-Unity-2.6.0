...
public class UIAtlasInspector : Editor
{
	...
	public override void OnInspectorGUI ()
	{
		...
		if (mType == AtlasType.Reference)
		{
			...
			NGUIEditorTools.DrawSeparator();
			NGUIEditorTools.HelpBox("You can have one atlas simply point to " +
		...
		{
			NGUIEditorTools.DrawSeparator();
			Material mat = EditorGUILayout.ObjectField("Material", mAtlas.spriteMaterial, typeof(Material)) as Material;
			...
			if (mat != null)
			{
				TextAsset ta = EditorGUILayout.ObjectField("TP Import", null, typeof(TextAsset)) as TextAsset;
				if (ta != null)
				{
					// Ensure that this atlas has valid import settings
					if (mAtlas.texture != null) NGUIEditorTools.ImportTexture(mAtlas.texture, false, false);
