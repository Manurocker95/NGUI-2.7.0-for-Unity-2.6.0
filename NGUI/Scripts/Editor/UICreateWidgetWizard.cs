...
public class UICreateWidgetWizard : EditorWindow
{
	...
	GameObject sel = EditorGUILayout.ObjectField(go, typeof(GameObject), GUILayout.Width(140f)) as GameObject;
	...
	void OnGUI ()
	{
		...
		if (go == null)
		{
			...
			{
			EditorWindow.GetWindow(typeof(UICreateNewUIWizard), false, "New UI");
			}
		}
		else
		{
